...
class ControllersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create controller" do
    assert_difference('Controller.count') do
      post controllers_url, params: { controller: { list__name: @controller.list__name, list_due_date: @controller.list_due_date, todo_list: @controller.todo_list } }
    end
  ...
  test "should update controller" do
    patch controller_url(@controller), params: { controller: { list__name: @controller.list__name, list_due_date: @controller.list_due_date, todo_list: @controller.todo_list } }
